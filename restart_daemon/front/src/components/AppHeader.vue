  ...
  <header class="header-container">
    <nav class="nav-bar">
      ...
      <div class="nav-group center">
        <router-link to="/" class="nav-link">TELEMETRY</router-link>
        <router-link to="/blackbox" class="nav-link">BLACKBOX</router-link>
      </div>

      <div class="nav-group right">
        <button class="system-panel-btn" @click="isSettingsOpen = true">
          SETTINGS
        </button>
