...
#define RESTART_HOLD_SEC             15  /* тримати пін RESTART активним стільки секунд         */
#define RESTART_TIMEOUT_DEFAULT_SEC  120  /* дефолтний watchdog-таймаут, поки RPi не пришле свій */
...
typedef union {
    struct __attribute__((packed)) {
        ...
        uint8_t  reserved[5];      // запас: майбутні команди керування тощо
        uint16_t crc;
    } field;
