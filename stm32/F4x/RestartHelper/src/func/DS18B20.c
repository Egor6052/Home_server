...
//     // Це заглушка, щоб перевірити прошивку. 
//     // Якщо ти бачиш 0.00 - ти не прошив контролер!
//     // return 12.0f; 
...
//     // Затримка на конвертацію. 
//     // Якщо живлення паразитне (2 дроти) - треба підтягувати сильно.
//     // Якщо звичайне (3 дроти) - просто чекаємо.
// 	HAL_Delay(750); 
...
//     // Якщо отримали 0 - значить лінія лежить в Low (перевір резистор!)
//     // Якщо отримали -1 (або 4095) - лінія висить в High (датчик не відповідає/не припаяний)
// 	// return (float)(temp_com / 16.0);
// 	uint16_t temp_raw = (uint16_t)(temp_com * 100 / 16);

//  	if ((float)temp_raw < -99) {
// 		sensor_data.status = 0x02;
// 	} else {
// 		sensor_data.temperature = (int16_t)(temp_raw * 100);
// 	}
// }
